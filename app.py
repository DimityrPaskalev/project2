...
st.set_page_config(page_tittle="Handwritten Digit Recognition", page_icon="✍️")
st.tittle("✍️Handwritten Digit Recognition")
st.write("Upload a handwritten digit image and AI will try to recognise it.")
...
digits = load_digits()
X = digits.images.reshape((lean(digits.images), -1)) / 16.0
y = digits.target
